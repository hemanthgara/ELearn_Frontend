...
const Comment = ({ id = "" }) => {
  ...
  const { comments, replies, fetchingComment } = useSelector(
    ...
    <>
      <div className="comments-container container">
        <div className="comments-list">
          {comments.length > 0 && !fetchingComment ? (
                  ...
                  <div className="comment my-2 fs-5 position-relative">
                    <div className="py-2 d-flex justify-content-between ">
                      ...
                      {pathname === "/viewqueries" ? (
                        <Link to={`/viewcourse/showcontent/videodetail/${comment.video_id}`}>
                          See video
                        </Link>
                      ) : (
                        <span></span>
                        ...
                        return (
                          ...
                          >
                            <div className=" d-flex justify-content-between ">
                              ...
                              <div className="">
                                {pathname === "/viewqueries" ? (
                                  <Link to={`/viewcourse/showcontent/videodetail/${reply.video_id}`}>
                                    See video
                                  </Link>
                                ) : (
                                  <span></span>
